...
<div class="space-y-8">
    ...
    <div class="text-center">
        ...
        <h1 class="text-4xl font-bold text-[#004a7f] mb-2">समाचार</h1>
        <p class="text-gray-600 max-w-2xl mx-auto">नेपाल पत्रकार महासंघका नवीनतम समाचार र घटनाक्रमहरू</p>
    </div>
    ...
    @if($news->count() > 0)
        ...
        <div class="bg-gradient-to-r from-[#0073b7]/5 to-[#004a7f]/5 rounded-lg p-6">
            <div class="flex items-center mb-6">
                ...
                <h2 class="text-2xl font-bold text-[#004a7f]">नवीनतम समाचार</h2>
            </div>
    ...
    @else
        ...
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">कुनै समाचार फेला परेन</h3>
